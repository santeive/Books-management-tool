 ...
 * @subpackage Books_Mgm_Tool/public
 */
...
class Books_Mgm_Tool_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/books-mgm-tool-public.css', array(), $this->version, 'all' );
